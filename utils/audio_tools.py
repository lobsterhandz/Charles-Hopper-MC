...
from utils.speech_tools import save_bark_tts  # writes out TTS WAV files
...
def sync_bars_to_beat(
    ...
    clips: dict[int, Optional[AudioSegment]] = {}

    def synthesize_one(idx: int, bar_text: str) -> Optional[AudioSegment]:
        try:
            wav_path = f"generated/bar_{idx}.wav"
            save_bark_tts(bar_text, wav_path)
